...
const TranscriptEditModalWrapper = ({ transcript, segmentUUID }: { transcript: string, segmentUUID: string }) => {
    ...
    <AlertDialog.Root open={open} onOpenChange={setOpen}>
      ...
      <AlertDialog.Portal>
        ...
        <AlertDialog.Content className="fixed top-1/2 left-1/2 max-h-[80vh] w-[90vw] max-w-xl -translate-x-1/2 -translate-y-1/2 rounded-lg bg-white p-6 shadow-md">
          ...
          <TranscriptEditor text={transcript} segmentUUID={segmentUUID} setOpen={setOpen} />
          {/* <div>
...
export default TranscriptEditModalWrapper;
