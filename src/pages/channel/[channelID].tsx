...
const ChannelPage: NextPage = () => {
  ...
  return <>
    <Head>
      <title>{(channel.data?.pages?.[0]?.channelInfo?.handle?.replace("@","") ?? "Channel") + " | Identify YouTube Channel Sponsors with SponsorTube"}</title>
      <meta name="description" content="Analyze channel sponsor information" />
    </Head>
    <Header />
    <section>
      {channel.isLoading ? (
